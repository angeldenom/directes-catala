    ...
    return (
        <main className="px-4 mx-auto my-12 max-w-6xl">
            <div className="space-y-6">
                ...
                <p className="text-lg">El codi està penjat a un repositori de GitHub. Qualsevol el pot millorar i penjar la seva còpia.</p>
                <p className="text-lg">El projecte està configurat en un docker compose amb dues parts:</p>
